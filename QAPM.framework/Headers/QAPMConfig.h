...
/**
 ...
 不设置则使用通过后台下发配置控制抽样率（后台下发默认0.01，百分之一)
 */
...
/**
 设置内存分配采集堆栈功能抽样率，开启功能后以随机抽样用户，命中则被开启功能
 不设置则使用通过后台下发配置控制抽样率（后台下发默认0.01，百分之一)
 */
@property (nonatomic, assign) float sampleRate;
...
/**
 设置功能抽样率，开启功能后以随机抽样用户，命中则被开启功能
 不设置则使用通过后台下发配置控制抽样率（后台下发默认1，百分之百)
 */
@property (nonatomic, assign) float sampleRate;
...
/**
 设置耗时打点统计上报功能
 */
@property (nonatomic, strong) QAPMTimeStatisticConfig *timeStatisticConfig;
